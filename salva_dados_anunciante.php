						...
						if ($outra_tabela==""){
							...
							if ($acao=="altera_img"){
								...
								try {
									...
									$sql = "update imagens set id_ref=:id_ref,top_ref=:top_ref,id_anunciante=:id_anunciante,img=:arquivo,extensao=:extensao,tp_img=:tp_img,larg=:largura,alt=:altura,img_tit=:tit_arq,img_desc=:desc_arq,img_cred=:cred_arq where id=:id";
									...
									$up -> bindParam(':id_anunciante',$id_anunciante,PDO::PARAM_STR);
								...
								try {
									...
									$sql="insert into imagens (id_ref,top_ref,id_anunciante,img,extensao,tp_img,larg,alt,img_tit,img_desc,img_cred) values(:id,:top_ref,:id_anunciante,:arquivo,:extensao,:tp_img,:largura,:altura,:tit_arq,:desc_arq,:cred_arq)";
									...
									$ins -> bindParam(':id_anunciante',$id_anunciante,PDO::PARAM_STR);
