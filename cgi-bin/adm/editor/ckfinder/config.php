...
//$config['LicenseName'] = 'Portal Hosting';
...
//$baseUrl = 'http://www.portalhosting.net.br/img_up/usuarios/'.$_COOKIE['id_adm'].'/';
$baseUrl = $_COOKIE['base_ck'];//$base_ck;
//echo $baseUrl;
