...
if (version_compare(PHP_VERSION, '5.0.0', '<') ) exit("Desculpe, esta versão do PHPMailer só será executado em PHP versão 5 ou superior!!\n");
...
*/
    ...
    //$result .= $this->HeaderLine('X-Mailer', 'PHPMailer '.$this->Version.' 1.0');
